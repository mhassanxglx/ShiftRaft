 ...
 * This file demonstrates how to integrate Shiftraft with a web frontend
 */

// For React/Vue/Angular applications
export class ShiftraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ShiftraftClient(provider, contractAddress);
